...
# 3. 外部卷 (修复了 storage_location_name 报错)
resource "snowflake_external_volume" "cosmetics_volume" {
  name = "COSMETICS_S3_VOLUME"
  
  storage_location {
    storage_location_name = "my-s3-cosmetics" # 修复：改为 storage_location_name
    storage_provider      = "S3"
